...
namespace @java.@lang
{
public partial interface @Comparable : global::@java.@lang.@Object
{
    ...
    internal static nint __ABG__Class
    {
        get
        {
            ...
            var ptr = global::UnityEngine.AndroidJNI.NewGlobalRef(global::UnityEngine.AndroidJNI.FindClass(@"java/lang/Comparable"));
    ...
    public static @Comparable? UnsafeFromRawObjectAndDeleteLocalRef(nint rawObject)
    {
    ...
    public static @Comparable? UnsafeFromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
        return new @__ABG__Anonymous(rawObject);
    }

    public static @Comparable? FromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
    ...
    public static @Comparable? FromRawObject(global::AndroidBindgen.IAndroidJavaObject source) => source != null ? FromRawObject(source.GetRawObject()) : null;
internal class __ABG__Anonymous :  global::@java.@lang.@Object.__ABG__Anonymous, @Comparable
{
