...
{
public partial interface @MediaCrypto : global::@java.@lang.@Object
{
    ...
    internal static nint __ABG__Class
    {
        get
        {
            ...
            var ptr = global::UnityEngine.AndroidJNI.NewGlobalRef(global::UnityEngine.AndroidJNI.FindClass(@"android/media/MediaCrypto"));
    ...
    public static @MediaCrypto? UnsafeFromRawObjectAndDeleteLocalRef(nint rawObject)
    {
    ...
    public static @MediaCrypto? UnsafeFromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
        return new @__ABG__Anonymous(rawObject);
    }

    public static @MediaCrypto? FromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
    ...
    public static @MediaCrypto? FromRawObject(global::AndroidBindgen.IAndroidJavaObject source) => source != null ? FromRawObject(source.GetRawObject()) : null;
internal class __ABG__Anonymous :  global::@java.@lang.@Object.__ABG__Anonymous, @MediaCrypto
{
