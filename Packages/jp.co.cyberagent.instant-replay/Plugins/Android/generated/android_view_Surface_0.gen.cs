...
{
public partial interface @Surface : global::@java.@lang.@Object, global::@android.@os.@Parcelable
{
    ...
    internal static nint __ABG__Class
    {
        get
        {
            ...
            var ptr = global::UnityEngine.AndroidJNI.NewGlobalRef(global::UnityEngine.AndroidJNI.FindClass(@"android/view/Surface"));
    ...
    public static @Surface? UnsafeFromRawObjectAndDeleteLocalRef(nint rawObject)
    {
    ...
    public static @Surface? UnsafeFromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
        return new @__ABG__Anonymous(rawObject);
    }

    public static @Surface? FromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
    ...
    public static @Surface? FromRawObject(global::AndroidBindgen.IAndroidJavaObject source) => source != null ? FromRawObject(source.GetRawObject()) : null;
internal class __ABG__Anonymous :  global::@java.@lang.@Object.__ABG__Anonymous, @Surface
{
