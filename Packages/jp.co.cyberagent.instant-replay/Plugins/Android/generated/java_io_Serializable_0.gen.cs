...
namespace @java.@io
{
public partial interface @Serializable : global::@java.@lang.@Object
{
    ...
    internal static nint __ABG__Class
    {
        get
        {
            ...
            var ptr = global::UnityEngine.AndroidJNI.NewGlobalRef(global::UnityEngine.AndroidJNI.FindClass(@"java/io/Serializable"));
    ...
    public static @Serializable? UnsafeFromRawObjectAndDeleteLocalRef(nint rawObject)
    {
    ...
    public static @Serializable? UnsafeFromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
        return new @__ABG__Anonymous(rawObject);
    }

    public static @Serializable? FromRawObject(nint rawObject)
    {
        if (rawObject == (nint)0) return null;
    ...
    public static @Serializable? FromRawObject(global::AndroidBindgen.IAndroidJavaObject source) => source != null ? FromRawObject(source.GetRawObject()) : null;
internal class __ABG__Anonymous :  global::@java.@lang.@Object.__ABG__Anonymous, @Serializable
{
