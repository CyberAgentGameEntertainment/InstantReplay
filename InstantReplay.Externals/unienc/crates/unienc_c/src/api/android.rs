...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn JNI_OnLoad(vm: *mut c_void, reserved: *mut c_void) -> c_int { unsafe {
...
pub unsafe fn set_stdout_redirect(log_tag: &'static str) -> Result<(), AndroidApiError> { unsafe {
    ...
    thread::spawn(move || {
        ...
        let pipe_read_end = File::from_raw_fd(pipe_fds[0]);
